...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 390, 460, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 130, 280, 10, 10, 10, ({desdeX: 130, hastaX: 200, desdeY: 280, hastaY: 340})),
    new ZombieCaminante('imagenes/zombie1.png', 230, 280, 10, 10, 10, ({desdeX: 230, hastaX: 290, desdeY: 280, hastaY: 380}))
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    this.jugador.sprite = 'imagenes/auto_rojo_' + tecla + '.png';
  }
};
...
Juego.dibujar = function() {
  ...
  //Funcion mia: dibujar linea de llegada

  Dibujante.dibujarRectangulo('black', 773, 530, 10, 10);
  Dibujante.dibujarRectangulo('white', 783, 530, 10, 10);
  Dibujante.dibujarRectangulo('black', 793, 530, 10, 10);
  Dibujante.dibujarRectangulo('white', 803, 530, 10, 10);
  Dibujante.dibujarRectangulo('black', 813, 530, 10, 10);
  Dibujante.dibujarRectangulo('white', 823, 530, 10, 10);
  Dibujante.dibujarRectangulo('black', 833, 530, 10, 10);
  Dibujante.dibujarRectangulo('white', 843, 530, 10, 10);
  Dibujante.dibujarRectangulo('black', 853, 530, 10, 10);
  Dibujante.dibujarRectangulo('white', 863, 530, 10, 10);

  Dibujante.dibujarRectangulo('white', 773, 540, 10, 10);
  Dibujante.dibujarRectangulo('black', 783, 540, 10, 10);
  Dibujante.dibujarRectangulo('white', 793, 540, 10, 10);
  Dibujante.dibujarRectangulo('black', 803, 540, 10, 10);
  Dibujante.dibujarRectangulo('white', 813, 540, 10, 10);
  Dibujante.dibujarRectangulo('black', 823, 540, 10, 10);
  Dibujante.dibujarRectangulo('white', 833, 540, 10, 10);
  Dibujante.dibujarRectangulo('black', 843, 540, 10, 10);
  Dibujante.dibujarRectangulo('white', 853, 540, 10, 10);
  Dibujante.dibujarRectangulo('black', 863, 540, 10, 10);
